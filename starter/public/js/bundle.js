...
var showAlert = exports.showAlert = function showAlert(type, mesg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(mesg, "</div>");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          _context.prev = 10;
          _context.t0 = _context["catch"](0);
          errorMessage = _context.t0.response && _context.t0.response.data && _context.t0.response.data.message ? _context.t0.response.data.message : 'Something went wrong.';
          (0, _alert.showAlert)('error', errorMessage);
          console.error(_context.t0.response ? _context.t0.response.data : _context.t0); // Log full error object for debugging
        case 15:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../../node_modules/axios/index.js","../js/alert":"alert.js"}],"index.js":[function(require,module,exports) {
"use strict";
